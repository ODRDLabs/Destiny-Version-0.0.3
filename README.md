...
- #New feature - Animated print support for text to speech.
- #New feature - Engine definition as global function so that it can be called and used anywhere.
